...
**ECDH** (**EC** version of **DH**) - is a **key exchange method**. The **DH** stand for *Diffie–Hellman*.<br>
**ECDSA** (**EC** version of **DSA**) - is a **signature algorithm**. The **DSA** stand for *Digital Signature Algorithm*.<br>

<br>

**Curve25519** is the name of a **specific elliptic curve**. Other curves are named **Curve448**, **P-256**, **P-384**, and **P-521**.<br>

<br>

**Implementations**:
- **X25519** is an **implementation** of **ECDH** over **Curve25519**;
- **Ed25519** is the name of a **concrete variation** of **EdDSA**;
  - **Ed25519** is an **EdDSA** using **SHA-512** and **Curve25519**;
...
- **Anonymous DH** (**ADH**): использование алгоритма DH **без аутентификации** открытых параметров DH;
